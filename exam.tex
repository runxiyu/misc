...
% KNOWN BUGS
% 1. \ensurefour causes page numbers to alternate between every run
% 2. The last page before \ensurefour puts blank pages may still have a [Turn over
...
\NewDocumentCommand{\ensurefour} { }
	{
		\label{pagebeforefour}
		\prg_replicate:nn
		{ \int_mod:nn { 4 - \int_mod:nn { \getpagerefnumber{pagebeforefour} } { 4 } } { 4 } }
		{ \blankpage }
	}
\ExplSyntaxOff
